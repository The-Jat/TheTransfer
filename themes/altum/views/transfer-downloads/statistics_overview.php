    ...
    <div class="row m-n2">
        <div class="col-12 col-sm-6 p-2 position-relative text-truncate">
            <div class="card d-flex flex-row h-100 overflow-hidden">
                ...
                <div class="card-body text-truncate">
                    <span class="h6"><?= nr($data->totals['pageviews']) . ' ' . l('transfer_downloads.downloads') ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-sm-6 p-2 position-relative text-truncate">
            <div class="card d-flex flex-row h-100 overflow-hidden">
                ...
                <div class="card-body text-truncate">
                    <span class="h6"><?= nr($data->totals['visitors']) . ' ' . l('transfer_downloads.unique_downloads') ?></span>
                </div>
            </div>
        </div>
    </div>
...
<div class="d-flex align-items-center">
    <h2 class="small font-weight-bold text-uppercase text-muted mb-0 mr-3" data-toggle="tooltip" title="<?= sprintf(l('transfer_statistics.data_preview_info'), $this->user->preferences->default_results_per_page ?? settings()->main->default_results_per_page) ?>">
        <i class="fas fa-fw fa-sm fa-info-circle mr-1"></i> <?= l('transfer_statistics.data_preview') ?>
    </h2>
...
<div class="row mb-4">
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
                    ...
                    <div class="mt-4">
                        <div class="d-flex justify-content-between mb-1">
                            <div class="text-truncate">
                                <?php if($key): ?>
                                    <a href="<?= url('transfer-downloads/' . $data->transfer->transfer_id . '?type=country&continent_code=' . $key . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" title="<?= $key ?>" class="">
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('transfer-downloads/' . $data->transfer->transfer_id . '?type=continent_code&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
                    ...
                    <div class="mt-4">
                        <div class="d-flex justify-content-between mb-1">
                            <div class="text-truncate">
                                ...
                                <?php if($key): ?>
                                    <a href="<?= url('transfer-downloads/' . $data->transfer->transfer_id . '?type=city_name&country_code=' . $key . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" title="<?= $key ?>" class=""><?= get_country_from_country_code($key) ?></a>
                                <?php else: ?>
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('transfer-downloads/' . $data->transfer->transfer_id . '?type=country&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('transfer-downloads/' . $data->transfer->transfer_id . '?type=city_name&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            <div class="card-body">
                <h3 class="h5"><?= l('transfer_statistics.referrer_host') ?></h3>
                <p></p>
                        ...
                        <div class="d-flex justify-content-between mb-1">
                            <div class="text-truncate">
                                ...
                                <?php else: ?>
                                    ...
                                    <a href="<?= url('transfer-downloads/' . $data->transfer->transfer_id . '?type=referrer_path&referrer_host=' . $key . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" title="<?= $key ?>" class=""><?= $key ?></a>
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('transfer-downloads/' . $data->transfer->transfer_id . '?type=referrer_host&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            <div class="card-body">
                <h3 class="h5"><?= l('transfer_statistics.device') ?></h3>
                <p></p>
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('transfer-downloads/' . $data->transfer->transfer_id . '?type=device&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            <div class="card-body">
                <h3 class="h5"><?= l('transfer_statistics.os') ?></h3>
                <p></p>
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('transfer-downloads/' . $data->transfer->transfer_id . '?type=os&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            <div class="card-body">
                <h3 class="h5"><?= l('transfer_statistics.browser') ?></h3>
                <p></p>
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('transfer-downloads/' . $data->transfer->transfer_id . '?type=browser&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            <div class="card-body">
                <h3 class="h5"><?= l('transfer_statistics.language') ?></h3>
                <p></p>
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('transfer-downloads/' . $data->transfer->transfer_id . '?type=language&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
</div>
...
<div>
    <div class="d-flex align-items-center mb-3">
        <h2 class="small font-weight-bold text-uppercase text-muted mb-0 mr-3"><i class="fas fa-fw fa-sm fa-chart-bar mr-1"></i> <?= l('transfer_statistics.latest') ?></h2>
    ...
    <div class="table-responsive table-custom-container">
        <table class="table table-custom">
                ...
                <tr>
                    ...
                    <td class="text-nowrap">
                        ...
                        <?php else: ?>
                            ...
                            <a href="<?= url('transfer-downloads/' . $data->transfer->transfer_id . '?type=referrer_path&referrer_host=' . $row->referrer_host . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" title="<?= $row->referrer_host ?>" class=""><?= $row->referrer_host ?></a>
            ...
            <tr>
                <td colspan="7">
                    <a href="<?= url('transfer-downloads/' . $data->transfer->transfer_id . '?type=entries&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none small">
...
<?php if (!empty($data->pageviews)): ?>
    ...
    pageviews_color_gradient.addColorStop(0, set_hex_opacity(pageviews_color, 0.1));
    pageviews_color_gradient.addColorStop(1, set_hex_opacity(pageviews_color, 0.025));

    visitors_color_gradient = pageviews_chart.createLinearGradient(0, 0, 0, 250);
    visitors_color_gradient.addColorStop(0, set_hex_opacity(visitors_color, 0.1));
    visitors_color_gradient.addColorStop(1, set_hex_opacity(visitors_color, 0.025));
    ...
    new Chart(pageviews_chart, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: <?= json_encode(l('transfer_downloads.downloads')) ?>,
                ...
                {
                    label: <?= json_encode(l('transfer_downloads.unique_downloads')) ?>,
