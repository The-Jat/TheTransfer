...
<div>
    ...
    <div class="table-responsive table-custom-container">
        <table class="table table-custom">
            ...
            <tr>
                <td colspan="7">
                    <a href="<?= url('transfer-downloads/' . $data->transfer->transfer_id . '?type=entries&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted">
