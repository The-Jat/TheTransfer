...
<div>
    <?php foreach($features as $feature => $is_enabled): ?>
        <?php if($is_enabled && $feature == 'storage_size_limit'): ?>
        ...
        <?php if($is_enabled && $feature == 'transfers_limit'): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
        ...
        <?php if($is_enabled && $feature == 'transfer_size_limit'): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
        ...
        <?php if($is_enabled && $feature == 'files_per_transfer_limit'): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
        ...
        <?php if($is_enabled && $feature == 'downloads_per_transfer_limit'): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
        ...
        <?php if($is_enabled && $feature == 'transfers_retention'): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
        ...
        <?php if($is_enabled && $feature == 'download_unlocking_time'): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
                ...
                <i class="fas fa-fw fa-sm <?= 1 ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
            </div>
        <?php endif ?>
        ...
        <?php if($is_enabled && $feature == 'pixels_limit' && settings()->transfers->pixels_is_enabled): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
        ...
        <?php if($is_enabled && $feature == 'domains_limit' && settings()->transfers->domains_is_enabled): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
        ...
        <?php if($is_enabled && $feature == 'additional_domains' && settings()->transfers->additional_domains_is_enabled): ?>
        ...
        <?php if($is_enabled && $feature == 'statistics_retention'): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
        ...
        <?php if($is_enabled && $feature == 'analytics_is_enabled'): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
                ...
                <i class="fas fa-fw fa-sm <?= $data->plan_settings->analytics_is_enabled ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
            </div>
        <?php endif ?>

        <?php if($is_enabled && $feature == 'password_protection_is_enabled'): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
                ...
                <i class="fas fa-fw fa-sm <?= $data->plan_settings->password_protection_is_enabled ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
            </div>
        <?php endif ?>

        <?php if($is_enabled && $feature == 'file_encryption_is_enabled'): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
                ...
                <i class="fas fa-fw fa-sm <?= $data->plan_settings->file_encryption_is_enabled ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
            </div>
        <?php endif ?>

        <?php if($is_enabled && $feature == 'custom_url_is_enabled'): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
                ...
                <i class="fas fa-fw fa-sm <?= $data->plan_settings->custom_url_is_enabled ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
            </div>
        <?php endif ?>
        ...
        <?php if($is_enabled && $feature == 'removable_branding_is_enabled'): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
                ...
                <i class="fas fa-fw fa-sm <?= $data->plan_settings->removable_branding_is_enabled ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
            </div>
        <?php endif ?>
        ...
        <?php if($is_enabled && $feature == 'qr_is_enabled'): ?>
            <div class="d-flex justify-content-between align-items-center my-3">
                ...
                <i class="fas fa-fw fa-sm <?= $data->plan_settings->qr_is_enabled ? 'fa-check text-success' : 'fa-times text-muted' ?>"></i>
            </div>
        <?php endif ?>
