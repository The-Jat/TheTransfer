...
<div class="container mt-4">
    <nav class="navbar navbar-expand-lg navbar-light bg-white rounded <?= \Altum\Router::$controller_key == 'index' ? null : 'mb-5' ?>">
        <div class="container">
            <a
                    href="<?= url() ?>"
                                ...
                                <div class="d-flex flex-column flex-lg-row">
                                    <div class="pr-lg-3">
                                        <div class="px-3 py-2 font-weight-bold">
                                            <?php if(settings()->main->{'logo_' . \Altum\ThemeStyle::get()} != ''): ?>
                                                <img src="<?= settings()->main->{'logo_' . \Altum\ThemeStyle::get() . '_full_url'} ?>" class="img-fluid navbar-logo-mini mr-2" alt="<?= l('global.accessibility.logo_alt') ?>" data-toggle="tooltip" title="<?= settings()->main->title ?>" />
                                            <?php else: ?>
                                                <?= settings()->main->title ?>
                                            <?php endif ?>
                                        </div>
                                        ...
                                        <a class="dropdown-item <?= in_array(\Altum\Router::$controller, ['Transfers', 'TransferUpdate', 'Transfer', 'TransferDownloads', 'TransferStatistics', 'TransferQr']) ? 'active' : null ?>" href="<?= url('transfers') ?>"><i class="fas fa-fw fa-sm fa-paper-plane mr-2"></i> <?= l('transfers.menu') ?></a>
                                        ...
                                        <a class="dropdown-item <?= in_array(\Altum\Router::$controller, ['Pixels', 'PixelUpdate', 'PixelCreate']) ? 'active' : null ?>" href="<?= url('pixels') ?>"><i class="fas fa-fw fa-sm fa-adjust mr-2"></i> <?= l('pixels.menu') ?></a>
                                        <?php endif ?>

                                        <?php if(settings()->transfers->projects_is_enabled): ?>
                                        <a class="dropdown-item <?= in_array(\Altum\Router::$controller, ['Projects', 'ProjectUpdate', 'ProjectCreate']) ? 'active' : null ?>" href="<?= url('projects') ?>"><i class="fas fa-fw fa-sm fa-project-diagram mr-2"></i> <?= l('projects.menu') ?></a>
                                        <?php endif ?>
                                    </div>
