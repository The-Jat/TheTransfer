        ...
        <ul class="admin-sidebar-links">
            ...
            <li class="<?= in_array(\Altum\Router::$controller, ['AdminTransfers']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/transfers') ?>">
                    <i class="fas fa-fw fa-sm fa-paper-plane mr-2"></i> <?= l('admin_transfers.menu') ?>
                </a>
            </li>

            <li class="<?= in_array(\Altum\Router::$controller, ['AdminFiles']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/files') ?>">
                    <i class="fas fa-fw fa-sm fa-copy mr-2"></i> <?= l('admin_files.menu') ?>
                </a>
            </li>
