            ...
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold"><?= l('admin_transfers.menu') ?></small>
                    </div>
                    <div class="col-auto">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/transfers') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4" id="transfers">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                    </a>

                    <div class="mt-1 small text-muted">
                        <span id="transfers_current_month">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold"><?= l('admin_files.menu') ?></small>
                    </div>
                    <div class="col-auto">
                    <span class="p-2 bg-primary-100 rounded">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/files') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4" id="files">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                    </a>

                    <div class="mt-1 small text-muted">
                        <span id="files_current_month">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                        <?= mb_strtolower(l('global.date.this_month')) ?>
                    </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold"><?= l('transfer.total_size') ?></small>
                    </div>
                    <div class="col-auto">
                    <span class="p-2 bg-primary-100 rounded">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/transfers') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4" id="transfers_total_size">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                    </a>

                    <div class="mt-1 small text-muted">
                        <span id="transfers_total_size_current_month">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                        <?= mb_strtolower(l('global.date.this_month')) ?>
                    </div>
        ...
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body d-flex flex-column justify-content-between">
                <div class="row mb-5">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold">
                            <span id="transfers_total_pageviews">
                                <span class="spinner-border spinner-border-sm" role="status"></span>
                            </span>
                            <?= l('transfer.pageviews') ?>
                        </small>
                    </div>
                    <div class="col-auto">
                        <span class="p-2 bg-primary-100 rounded">
                ...
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold">
                            <span id="transfers_total_downloads">
                                <span class="spinner-border spinner-border-sm" role="status"></span>
                            </span>
                            <?= l('transfer.downloads') ?>
                        </small>
                    </div>
                    <div class="col-auto">
                        <span class="p-2 bg-primary-100 rounded">
    ...
    <script>
        (async function fetch_statistics() {
            ...
            if(data.status == 'error') {
                ...
                document.querySelector('#transfers').innerHTML = data.details.transfers ? nr(data.details.transfers) : 0;
                document.querySelector('#transfers_current_month').innerHTML = data.details.transfers_current_month ? nr(data.details.transfers_current_month) : 0;

                document.querySelector('#transfers_total_size').innerHTML = data.details.transfers_total_size ? data.details.transfers_total_size : 0;
                document.querySelector('#transfers_total_size_current_month').innerHTML = data.details.transfers_total_size_current_month ? data.details.transfers_total_size_current_month : 0;

                document.querySelector('#transfers_total_pageviews').innerHTML = data.details.transfers_total_pageviews ? nr(data.details.transfers_total_pageviews) : 0;
                document.querySelector('#transfers_total_downloads').innerHTML = data.details.transfers_total_downloads ? nr(data.details.transfers_total_downloads) : 0;

                document.querySelector('#files').innerHTML = data.details.files ? nr(data.details.files) : 0;
                document.querySelector('#files_current_month').innerHTML = data.details.files_current_month ? nr(data.details.files_current_month) : 0;
