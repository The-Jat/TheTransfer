...
<div class="card mb-5">
    <div class="card-body">
        <div class="d-flex justify-content-between mb-4">
            <h2 class="h4 text-truncate mb-0"><i class="fas fa-fw fa-copy fa-xs text-primary-900 mr-2"></i> <?= l('admin_statistics.files.header') ?></h2>
...
<script>
    ...
    new Chart(files_chart, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: <?= json_encode(l('admin_statistics.files.chart')) ?>,
