        ...
        <form action="" method="post" role="form">
            ...
            <div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" id="storage_size_limit" name="storage_size_limit" min="-1" class="form-control" value="0" required="required" />
                        <div class="input-group-append">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="transfers_limit" name="transfers_limit" min="-1" class="form-control" value="0" required="required" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" id="transfer_size_limit" name="transfer_size_limit" min="-1" class="form-control" value="0" required="required" />
                        <div class="input-group-append">
                            <span class="input-group-text"><?= l('global.mb') ?></span>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="files_per_transfer_limit" name="files_per_transfer_limit" min="-1" class="form-control" value="0" required="required" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>

                <div class="form-group">
                    <label for="downloads_per_transfer_limit"><?= l('admin_plans.plan.downloads_per_transfer_limit') ?></label>
                    <input type="number" id="downloads_per_transfer_limit" name="downloads_per_transfer_limit" min="-1" class="form-control" value="0" required="required" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" id="transfers_retention" name="transfers_retention" min="-1" class="form-control" value="0" required="required" />
                        <div class="input-group-append">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="download_unlocking_time" name="download_unlocking_time" min="-1" class="form-control" value="0" required="required" />
                ...
                <div class="form-group custom-control custom-switch">
                    <input id="file_encryption_is_enabled" name="file_encryption_is_enabled" type="checkbox" class="custom-control-input">
