...
$ad_exists = !empty(settings()->ads->footer_transfers);
...
if (defined('DEBUG_MODE') && DEBUG_MODE) {
    ...
    echo "\nFinal decision: "; echo $show_ad ? "✅ Show footer ad\n" : "❌ Do not show footer ad\n";

    echo "--- DEBUG FOOTER END ---</pre>";
}
/* ---------------- End debug ---------------- */

if ($show_ad): ?>
    <div class="container my-3 d-print-none">
        <?= settings()->ads->footer_transfers ?>
    </div>
<?php endif ?>
