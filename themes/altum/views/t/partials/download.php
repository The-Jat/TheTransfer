    ...
    <div class="col-10">
        ...
        <?php if($data->files_stats['total_files']): ?>
            <form action="" method="post" role="form">
                ...
                <?php foreach($data->files as $file): ?>
                    <div class="row align-items-center my-3">
                        <div class="col d-flex align-items-center text-truncate">
                            ...
                            <button type="submit" name="download" value="<?= $file->file_id ?>" class="btn btn-sm btn-link" data-toggle="tooltip" title="<?= l('global.download') ?>" <?= $data->transfer_user->plan_settings->download_unlocking_time > 0 ? 'disabled="disabled"' : null ?> data-download-button>
                ...
                <button type="submit" class="btn btn-block btn-primary mt-4" <?= $data->transfer_user->plan_settings->download_unlocking_time > 0 ? 'disabled="disabled"' : null ?> data-download-button>
