    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            $_POST['settings'] = [
                ...
                'storage_size_limit'                => (int) $_POST['storage_size_limit'],
                'transfers_limit'                   => (int) $_POST['transfers_limit'],
                'transfer_size_limit'               => (int) $_POST['transfer_size_limit'],
                'files_per_transfer_limit'          => (int) $_POST['files_per_transfer_limit'],
                'downloads_per_transfer_limit'      => (int) $_POST['downloads_per_transfer_limit'],
                'transfers_retention'               => (int) $_POST['transfers_retention'],
                'download_unlocking_time'           => (int) $_POST['download_unlocking_time'],
                ...
                'file_encryption_is_enabled'        => isset($_POST['file_encryption_is_enabled']),
            ...
            switch($plan_id) {
                ...
                case 'guest':
                    ...
                    $_POST['settings'] = [
                        ...
                        'additional_domains_is_enabled'     => isset($_POST['additional_domains_is_enabled']),
                        'analytics_is_enabled'              => isset($_POST['analytics_is_enabled']),
                        'qr_is_enabled'                     => isset($_POST['qr_is_enabled']),
                        'custom_url_is_enabled'             => isset($_POST['custom_url_is_enabled']),
                        'password_protection_is_enabled'    => isset($_POST['password_protection_is_enabled']),
