    ...
    public function index() {
        ...
        if(is_logged_in()) {
            ...
            if(user()->type == 1) {
                ...
                $available_pages[] = [
                    'name' => l('global.menu.admin') . ' - ' . sprintf(l('admin_settings.title'), l('admin_settings.transfers.tab')),
                    'url'  => 'admin/settings/transfers'
                ];
                ...
                /* Per product */
                $available_pages[] = [
                    'name' => l('global.menu.admin') . ' - ' . l('admin_transfers.menu'),
                    'url'  => 'admin/transfers'
                ];
                $available_pages[] = [
                    'name' => l('global.menu.admin') . ' - ' . l('admin_files.menu'),
                    'url'  => 'admin/files'
                ];
                $available_pages[] = [
                ...
                $available_pages[] = [
                    'name' => l('global.menu.admin') . ' - ' . l('admin_pixels.menu'),
                    'url'  => 'admin/pixels'
                ];
                $available_pages[] = [
