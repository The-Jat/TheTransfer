...
return [
    'admin_global.html_info' => 'This field accepts the usage of <code>span</code> HTML tag along with the <code>style</code> attribute.',
    'admin_global.html_info_tooltip' => 'Available CSS for the style attribute: color,font-weight,font-style,text-decoration,font-family,background-color,text-transform,margin,padding,text-align',
    ...
    'admin_plans.suggested_plan_id' => 'Suggested upgrade plan',
    'admin_plans.suggested_plan_id_help' => 'Display a plan as a suggestion to upgrade in the account plan page.',
    'admin_plans.suggested_plan_code_id' => 'Suggested upgrade - discount code',
    'admin_plans.suggested_plan_code_id_help' => 'Offer a discount code for the user to use when upgrading his plan.',
    ...
    'admin_plans.tag' => 'Tag',
    'admin_plans.tag_help' => 'Set a custom message to display on the plan (e.g. Most Popular).',
    'admin_plans.tag_background_color' => 'Background',
    'admin_plans.tag_text_color' => 'Text',
    ...
    'admin_plans.color' => 'Highlight color',
    ...
    'admin_plans.taxes_ids_help' => 'Select which of your %screated taxes%s you want to apply per plan.',
    ...
    'admin_plans.plan.unlimited' => 'Set <span class="badge badge-light" data-copy>-1</span> for unlimited.',
    ...
    'admin_plans.plan.storage_size_limit' => 'Storage size limit',
    'admin_plans.plan.transfers_limit' => 'Transfers limit',
    'admin_plans.plan.transfers_limit_help' => 'Set 0 to disable the guest file transfers.',
    'admin_plans.plan.transfer_size_limit' => 'Transfer size limit',
    'admin_plans.plan.files_per_transfer_limit' => 'Files per transfer limit',
    'admin_plans.plan.transfers_retention' => 'Transfers retention',
    'admin_plans.plan.transfers_retention_help' => 'How many days will the transfer be kept.',
    'admin_plans.plan.download_unlocking_time' => 'Download unlocking time (seconds)',
    'admin_plans.plan.download_unlocking_time_help' => 'Force users to wait for X amount of seconds before they can download a transfer.',
    'admin_plans.plan.downloads_per_transfer_limit' => 'Downloads per transfer limit',
    ...
    'admin_plans.plan.statistics_retention' => 'Transfers statistics retention',
    ...
    'admin_plans.plan.password_protection_is_enabled_help' => 'Enable access to set a password protection for transfer links.',
    'admin_plans.plan.file_encryption_is_enabled' => 'File encryption',
    'admin_plans.plan.file_encryption_is_enabled_help' => 'Enable access to set encrypt uploaded files.',
    'admin_plans.plan.analytics_is_enabled' => 'Analytics',
    'admin_plans.plan.analytics_is_enabled_help' => 'Enable analytics for the transfer links.',
    'admin_plans.plan.qr_is_enabled' => 'QR code builder',
    'admin_plans.plan.qr_is_enabled_help' => 'Enable QR code builder for transfers.',
    'admin_plans.plan.custom_url_is_enabled' => 'Custom back-half URL',
    'admin_plans.plan.custom_url_is_enabled_help' => 'Enable ability to choose a custom URL when creating a transfer.',
    'admin_plans.plan.removable_branding_is_enabled' => 'Removable branding',
    'admin_plans.plan.removable_branding_is_enabled_help' => 'Enable ability to remove the branding from the transfer pages.',
    'admin_plans.plan.custom_css_is_enabled' => 'Custom CSS',
    'admin_plans.plan.custom_css_is_enabled_help' => 'Enable ability to add custom css for each transfer page. Be aware to only allow trusted people to use this feature.',
    'admin_plans.plan.custom_js_is_enabled' => 'Custom JS',
    'admin_plans.plan.custom_js_is_enabled_help' => 'Enable ability to add custom js for each transfer page. Be aware to only allow trusted people to use this feature.',
    ...
    'admin_taxes.county' => 'County',
    'admin_taxes.state' => 'State',
    ...
    'admin_taxes_import.breadcrumb' => 'Import taxes',
    'admin_taxes_import.title' => 'Import taxes',
    'admin_taxes_import.menu' => 'Import taxes',
    'admin_taxes_import.header' => 'Import taxes',
    'admin_taxes_import.file' => 'CSV file',
    'admin_taxes_import.file_help' => 'The CSV file structure must be as per the csv file below.',
    'admin_taxes_import.file_help2' => 'Download example CSV file',
    'admin_taxes_import.success_message' => '%s taxes have been successfully imported.',
    ...
    'admin_tax_delete_modal.subheader' => 'If you delete a tax while it is being used for a previous registered payment, you will lose important invoice data. This action cannot be undone.',
    ...
    'admin_payment_create.breadcrumb' => 'Add payment',
    'admin_payment_create.title' => 'Add payment',
    'admin_payment_create.menu' => 'Add payment',
    'admin_payment_create.header' => 'Add a new payment',
    'admin_payment_create.subheader' => 'The vendor business details will be automatically taken from the %ssettings page%s.',
    'admin_payment_create.subheader2' => 'Once an payment & invoice is generated it can\'t be edited.',


    'admin_payments.title' => 'Payments list',
    'admin_payments.header' => 'Payments list',
    'admin_payments.menu' => 'Payments',
    'admin_payments.breadcrumb' => 'Payments',
    ...
    'admin_payments.payment_id' => 'External payment ID',
    'admin_payments.payment_id_help' => 'The unique ID of the payment from the payment processor used.',
    'admin_payments.plan_id' => 'Plan',
    'admin_payments.payment_processor' => 'Payment processor',
    'admin_payments.payment_type' => 'Payment type',
    'admin_payments.payment_frequency' => 'Payment frequency',
    'admin_payments.user_id' => 'User ID',
    'admin_payments.user_id_help' => 'Enter the user ID found on the user\'s profile page for the user you want to link this payment to. The user\'s billing details will also be used to generate the invoice.',
    'admin_payments.code' => 'Discount code',
    'admin_payments.discount_amount' => 'Discount amount',
    'admin_payments.email' => 'Custom payee email',
    'admin_payments.email_help' => 'If left empty, the email attached to the User ID will be used.',
    'admin_payments.name' => 'Custom payee name',
    'admin_payments.name_help' => 'If left empty, the name attached to the User ID will be used.',
    'admin_payments.taxes_ids' => 'Applied taxes',
    'admin_payments.taxes_ids_help' => 'Select which of your %screated taxes%s you want to apply.',
    'admin_payments.base_amount' => 'Base amount',
    'admin_payments.base_amount_help' => 'The original price of the plan excluding taxes & discounts.',
    'admin_payments.total_amount' => 'Total amount',
    'admin_payments.total_amount_help' => 'The final sum that the user paid, including taxes & discounts.',
    'admin_payments.currency' => 'Currency',
    'admin_payments.payment_proof' => 'Payment proof',
    'admin_payments.payment_proof_help' => 'Optional proof of payment to be attached.',
    'admin_payments.datetime_help' => 'The date of the payment. UTC timezone required.',
    'admin_payments.error_message.user_id_not_exists' => 'The user with this ID has not been found.',
    ...
    'admin_user_login_modal.success_message' => 'Successfully logged in as %s! To get out of this account simply use the Exit button at the top.',
    ...
    'admin_settings.payment_processors' => 'Processors',
    'admin_settings.social_logins' => 'Social logins',
    'admin_settings.social_logins.callback_url' => 'Callback URL',
	'admin_settings.extended' => 'Extended',
	'admin_settings.plugins' => 'Plugins',
	'admin_settings.system' => 'System',
	'admin_settings.interface' => 'Interface',
	'admin_settings.integrations' => 'Integrations',
    ...
    'admin_settings.users.blacklisted_domains_help' => 'Comma separated values of domain names. Users will not be able to register or login using any domain included in this list.',
    'admin_settings.users.blacklisted_ips' => 'Blacklisted IPs',
    'admin_settings.users.blacklisted_ips_help' => 'Comma separated values of IPs. Users will not be able to register or login using any IP included in this list.',
    'admin_settings.users.blacklisted_countries' => 'Select blacklisted countries',
    'admin_settings.users.blacklisted_countries_help' => 'Select the countries that you want to blacklist. Users will not be able to register or login from any countries that are selected. Detection is IP based.',
    ...
    'admin_settings.payment.type_both' => 'One time & recurring',
    'admin_settings.payment.brand_name' => 'Brand name',
    'admin_settings.payment.brand_name_help' => 'The brand name will be used for displaying the brand when users purchase via payment gates. (e.g. paypal)',
    'admin_settings.payment.currencies' => 'Currencies',
    'admin_settings.payment.currencies.code' => 'Currency code',
    'admin_settings.payment.currencies.code_help' => 'Currency code for the payments (e.g. USD, EUR, CAD). ISO 4217 standard.',
    'admin_settings.payment.currencies.symbol' => 'Currency symbol',
    'admin_settings.payment.currencies.display_as' => 'Display currency as',
    'admin_settings.payment.currencies.display_as_help' => 'This applies only for the plans/pricing section.',
    'admin_settings.payment.currencies.currency_placement' => 'Currency placement',
    'admin_settings.payment.currencies.currency_placement.left' => 'Left of price (e.g. $100)',
    'admin_settings.payment.currencies.currency_placement.right' => 'Right of price (e.g. 100€)',
    ...
    'admin_settings.payment.auto_currency_detection' => 'Enable auto currency detection',
    'admin_settings.payment.auto_currency_detection_help' => 'For new users (guests) - automatically detect and associate the right currency based on the users country and continent.',
    ...
    'admin_settings.payment.plan_features' => 'Plan feature visibility',
    ...
    'admin_settings.business.tab' => 'Invoice details',
    ...
    'admin_settings.business.invoice_nr_prefix_help' => 'Your Nr Prefix for all the invoices generated on the system. e.g. INV-',
    ...
    'admin_settings.business.tax_type_placeholder' => 'e.g. VAT',
    ...
    'admin_settings.captcha.transfer_upload_is_enabled' => 'Enable captcha on the transfer upload page',
    'admin_settings.captcha.transfer_download_is_enabled' => 'Enable captcha on the transfer download page',
   ...
   'admin_settings.facebook.tab' => 'Facebook login',
    ...
    'admin_settings.smtp.info_message.no_setup' => 'SMTP not configured, so the system can\'t send emails. <a href="%s" target="_blank">Setup SMTP</a>',
    ...
    'admin_settings.theme.font_family_help' => 'The CSS font family name (e.g. Times New Roman).',
    ...
    'admin_settings.custom.head_js_transfers' => 'Transfer pages head Javascript',
    'admin_settings.custom.head_css_transfers' => 'Transfer pages custom CSS',
    'admin_settings.custom.body_content_transfers' => 'Transfer pages body content',
    ...
    'admin_settings.internal_notifications.tab' => 'Internal notifs.',
	...
	'admin_settings.pwa.is_fullscreen' => 'Enable full screen support (iOS only)',
	'admin_settings.pwa.is_fullscreen_help' => 'If enabled, your PWA will not have a status bar at the top with the theme color. Instead it will be full screen, simulating a real app experience.',
	'admin_settings.pwa.dynamic_splash_screen' => 'Enable dynamic splash screen (iOS only)',
	'admin_settings.pwa.dynamic_splash_screen_help' => 'Android creates splash screens automatically. Enable this to generate them for iOS devices; otherwise, a blank splash screen will appear.',
    'admin_settings.pwa.display_install_bar' => 'Display install bar in the footer',
    'admin_settings.pwa.display_install_bar_for_guests' => 'Display install bar for guests',
    'admin_settings.pwa.display_install_bar_delay' => 'Delay until install bar shows up',
    'admin_settings.pwa.display_install_bar_minimum_pageviews_count' => 'Minimum session pageviews count before install bar shows up',
    ...
    'admin_settings.dynamic_og_images.tab' => 'Dynamic OGs',
    ...
    'admin_settings.cron.last_processing_time' => 'Last processing time: %s',
    'admin_settings.cron.reset' => 'Essential cron job',
    'admin_settings.cron.transfers_cleanup' => 'Transfers cleanup cron job',
    ...
    'admin_settings.ads.header_transfers' => 'Transfers header',
    'admin_settings.ads.footer_transfers' => 'Transfers footer',

    'admin_settings.transfers.tab' => 'Transfers',
    'admin_settings.transfers.pixels_is_enabled' => 'Enable the pixels system',
    'admin_settings.transfers.pixels_is_enabled_help' => 'Give your users the ability to add social networks pixels to their account and attach them to their resources for easy external tracking.',
    'admin_settings.transfers.random_url_length' => 'Random URL length',
    'admin_settings.transfers.random_url_length_help' => 'How many characters should be used to generate a random URL slug when a custom one is not given.',
    'admin_settings.transfers.branding' => 'Branding',
    'admin_settings.transfers.branding_help' => 'This branding is used by default in the transfer pages footer. HTML can be used in this field.',
    'admin_settings.transfers.branding_help2' => 'You can use the following dynamic variables: <code>{{WEBSITE_TITLE}}</code>, <code>{{URL}}</code>, <code>{{AFFILIATE_URL_TAG}}</code>.',
    'admin_settings.transfers.email_transfer_is_enabled' => 'Enable email transfers',
    'admin_settings.transfers.email_transfer_is_enabled_help' => 'Enabling this will give your users the ability to send files directly to other people\'s email.',
    'admin_settings.transfers.preview_file_extensions' => 'Preview extensions',
    'admin_settings.transfers.preview_file_extensions_help' => 'The extensions that allow file previewing before downloading. Only add supported extensions that can open in the browser. Comma separated values of keywords.',
    'admin_settings.transfers.blacklisted_file_extensions' => 'Blacklisted extensions',
    'admin_settings.transfers.blacklisted_file_extensions_help' => 'People will not be able to upload files with those extensions. Comma separated values of keywords.',
    'admin_settings.transfers.chunk_size_limit' => 'Chunk size limit',
    'admin_settings.transfers.chunk_size_limit_help' => 'When a user uploads bigger files, they are sent in chunks to the server. You are not able to set a higher limit than your actual server upload limit.',
    'admin_settings.transfers.offload_chunk_size_limit' => 'Offload chunk size limit',
    'admin_settings.transfers.offload_chunk_size_limit_help' => 'Applicable only when using an offloaded storage. After the file gets fully uploaded on the server, it will then be uploaded to the offloaded storage by chunks.',
    'admin_settings.transfers.projects_is_enabled' => 'Enable the Projects system',
    'admin_settings.transfers.projects_is_enabled_help' => 'Enabling this will give your users the ability to sort & tag their resources.',
    'admin_settings.transfers.domains_is_enabled' => 'Enable the Custom Domains system',
    'admin_settings.transfers.domains_is_enabled_help' => 'Enabling this will give your users the ability to add and use custom domains.',
    'admin_settings.transfers.additional_domains_is_enabled' => 'Enable the Additional Custom Domains system',
    'admin_settings.transfers.additional_domains_is_enabled_help' => 'Enabling this will give you the ability to add global domains via the admin panel that your users can use as additional domains.',
    'admin_settings.transfers.main_domain_is_enabled' => 'Enable the usage of the main domain',
    'admin_settings.transfers.main_domain_is_enabled_help' => 'Enabling this will give your users the ability to use the main domain to create links. This function will only work if the Custom Domains system is enabled and there is at least one global custom domain available. Even if this option is disabled, admins will still be allowed to use the main domain.',
    'admin_settings.transfers.domains_custom_main_ip' => 'IP of your server',
    'admin_settings.transfers.domains_custom_main_ip_help' => 'The IP that will be displayed when adding a custom domain. Leave empty to show the default detected server IP.',
    'admin_settings.transfers.blacklisted_domains' => 'Blacklisted domains',
    'admin_settings.transfers.blacklisted_domains_help' => 'People will not be able to submit any URL domain that is included in this list. Comma separated values of domains.',
    'admin_settings.transfers.blacklisted_keywords' => 'Blacklisted keywords',
    'admin_settings.transfers.blacklisted_keywords_help' => 'People will not be able to use any url alias that is included in this list. Comma separated values of keywords.',
    'admin_settings.transfers.report_is_enabled' => 'Enable the transfers report system',
    'admin_settings.transfers.report_is_enabled_help' => 'Enabling this will display a small flag icon that allows your users to transfer pages. The contact system must be enabled for this to work.',
    'admin_settings.transfers.parallel_file_uploading' => 'Enable parallel file uploading',
    'admin_settings.transfers.parallel_file_uploading_help' => 'Enabling this upload all selected files in parallel instead of one-by-one. Only enable this if your server can handle it.',
    'admin_settings.transfers.is_direct_offload_upload' => 'Enable offload direct upload',
    'admin_settings.transfers.is_direct_offload_upload_help' => 'Enabling this will make all file data transfer to be uploaded from the browser to the Offload storage directly, without a round-trip to your server. Only enable this if you use the Offloaded storage for uploads.',
    ...
    'admin_languages.info_message.max_input_vars_help' => 'Increase this setting from your host to at least %s or contact your webhost provider & ask them to change it for you.',
    ...
    'admin_statistics.transfers.menu' => 'Transfers',
    'admin_statistics.transfers.header' => 'Transfers',
    'admin_statistics.transfers.chart' => 'New transfers',

    'admin_statistics.files.menu' => 'Files',
    'admin_statistics.files.header' => 'Files',
    'admin_statistics.files.chart' => 'New files',

    'admin_statistics.statistics.menu' => 'Transfers statistics',
    'admin_statistics.statistics.header' => 'Transfers statistics',
    'admin_statistics.statistics.chart' => 'Pageviews',

    'admin_statistics.downloads.menu' => 'Transfers downloads',
    'admin_statistics.downloads.header' => 'Transfers downloads',
    'admin_statistics.downloads.chart' => 'Downloads',
    ...
    'admin_transfers.title' => 'Transfers',
    'admin_transfers.header' => 'Transfers',
    'admin_transfers.menu' => 'Transfers',


    'admin_files.title' => 'Files',
    'admin_files.header' => 'Files',
    'admin_files.menu' => 'Files',
];
