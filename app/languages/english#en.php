...
return [
    ...
    'global.emails.transfer_download.body' => 'Hello, <strong>{{NAME}}</strong>,<br /><br />Your transfer <strong>{{TRANSFER_NAME}}</strong> has just been downloaded.<br /><br /><strong>Country:</strong> {{COUNTRY_NAME}}<br /><strong>City:</strong> {{CITY_NAME}}<br /><strong>Device:</strong> {{DEVICE_TYPE}}<br /><strong>OS:</strong> {{OS_NAME}}<br /><strong>Browser:</strong> {{BROWSER_NAME}}<br /><br /><a href="{{TRANSFER_LINK}}" class="cta">View transfer</a><br /><br />Regards,<br />The {{WEBSITE_TITLE}} team.',
    ...
    'global.plan_settings.qr_is_enabled_help' => 'Custom QR code builder for transfers.',
    ...
    'index.menu' => 'Home',
    'index.title' => 'Easy file transfer',
    'index.meta_description' => '',
    'index.meta_keywords' => '',
    'index.header' => 'Easy file transfers',
    ...
    'index.stats' => 'We\'ve sent <span class=\'text-primary-400\'>%1$s files</span> with a total of <span class=\'text-primary-400\'>%2$s transfers</span> generated.',
    ...
    'api_documentation.downloads.start_date' => 'Start date in <code>Y-m-d</code> format.',
    'api_documentation.downloads.end_date' => 'End date in <code>Y-m-d</code> format.',
    'api_documentation.downloads.type' => 'Type of data to be returned. Allowed values are: <code>overview</code>, <code>referrer_host</code>, <code>referrer_path</code>, <code>continent_code</code>, <code>country_code</code>, <code>city_name</code>, <code>os_name</code>, <code>browser_name</code>, <code>device_type</code>, <code>browser_language</code>, <code>utm_source</code>, <code>utm_medium</code>, <code>utm_campaign</code>. Defaults to <code>overview</code>.',
    'api_documentation.downloads.country_code' => 'Parameter only available for the <code>city_name</code> type.',
    'api_documentation.downloads.utm_source' => 'Parameter only available for the <code>utm_medium</code> and <code>utm_campaign</code> type.',
    'api_documentation.downloads.utm_medium' => 'Parameter only available for the <code>utm_campaign</code> type.',
    ...
    'transfer_statistics.menu' => 'Statistics',
    'transfer_statistics.header' => '%s statistics',
    'transfer_statistics.link' => 'Statistics',
    ...
    'transfer_statistics.referrer_qr' => 'QR code',
    ...
    'transfer_qr.breadcrumb' => 'Transfer QR',
    'transfer_qr.title' => 'Transfer QR code - %s',
    'transfer_qr.menu' => 'QR Code',
    'transfer_qr.header' => '%s transfer QR code',
    'transfer_qr.subheader' => 'This QR code is meant to be downloaded, printed or shared so that your users can see and use it.',

    'transfer_qr.configurator.foreground_color' => 'Foreground color',
    'transfer_qr.configurator.background_color' => 'Background color',
    'transfer_qr.configurator.corner_radius' => 'Corner radius',
    'transfer_qr.configurator.type' => 'QR Type',
    'transfer_qr.configurator.type_normal' => 'Normal',
    'transfer_qr.configurator.type_text' => 'Insert custom text',
    'transfer_qr.configurator.type_image' => 'Insert custom logo',
    'transfer_qr.configurator.text' => 'Custom text',
    'transfer_qr.configurator.text_color' => 'Text color',
    'transfer_qr.configurator.text_size' => 'Text size',
    'transfer_qr.configurator.image_size' => 'Image size',
    'transfer_qr.configurator.ecc' => 'Error correction capability',
    'transfer_qr.configurator.ecc_l' => 'L - low (7%)',
    'transfer_qr.configurator.ecc_m' => 'M - medium (15%)',
    'transfer_qr.configurator.ecc_q' => 'Q - high (25%)',
    'transfer_qr.configurator.ecc_h' => 'H - best (30%)',
    'transfer_qr.print' => 'Print',
    ...
    'transfer.notification_handlers' => 'Notifications',
    'transfer.notification_handlers_help' => 'Get notified when your transfer gets downloaded.',
    ...
    't_transfer.download.simple_notification' => 'Your \'%1$s\' ( %2$s ) transfer has been downloaded.',
